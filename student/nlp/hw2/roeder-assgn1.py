...
# - combined (202)
# - more characters take it down to about 100 failures on the full-set.
#
# Backtracking was not implemented as the remaining failures don't show
# errors from MaxMatch's greedy nature: they are foreign language words.
#
